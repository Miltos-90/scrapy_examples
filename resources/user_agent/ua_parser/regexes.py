""" This module declares all constants and regexes needed for the Parser object (see parser.py).
    ...
    All regexes can be found on the repo: https://github.com/faisalman/ua-parser-js 
"""
...
# Read constants
with open('./data/windows_versions.json', mode = 'r', encoding = 'utf-8') as f: WINDOWS_VERSIONS = json.load(f)
with open('./data/safari_versions.json',  mode = 'r', encoding = 'utf-8') as f: SAFARI_VERSIONS  = json.load(f)
...
class REGEXDICT(TypedDict): # Type of each element of the lists defined below
    regex: re.Pattern
    props: dict
