...
# Read constants
with open('./data/windows_versions.json', mode = 'r', encoding = 'utf-8') as f:
    WINDOWS_VERSIONS = json.load(f)

with open('./data/safari_versions.json', mode = 'r', encoding = 'utf-8') as f:
    SAFARI_VERSIONS = json.load(f)
