""" Declaration of classes / datatypes used by more than one submodule """

from dataclasses      import dataclass
from typing           import TypedDict
from abc              import ABCMeta

OS_TYPES = {                                # Types of common operating systems
    'windows' : 'desktop',
    'macos'   : 'desktop', # May appear w/wo space character 
    'mac os'  : 'desktop', 
    'linux'   : 'desktop',
    'ios'     : 'mobile',
    'android' : 'mobile'
