...
import string
from .constants import OS, OS_TYPES, BROWSERS, TEMPLATES, android
...
class Generator():
    ...
    def __init__(self,
        osTypeDict  : dict = OS_TYPES,    # Dictionary with <os>:<type>
        osVersions  : dict = OS,          # Data for the operating systems
        brVersions  : dict = BROWSERS,    # Data for the browsers
        uaTemplates : dict = TEMPLATES,   # User agent templates
