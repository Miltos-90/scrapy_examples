...
import string
from .constants import NAME_TYPE, BRAND_TYPE


@dataclass
class Software():                           # Software object
    details : dict                          # Additional software details
    name    : Union[NAME_TYPE, BRAND_TYPE]  # Software name
...
class SoftwareFactory():
    ...
    def __call__(self, name: Union[NAME_TYPE, BRAND_TYPE]) -> Software:
    ...
    def _skipMinorVersion(
        name         : Union[NAME_TYPE, None], # Software name
