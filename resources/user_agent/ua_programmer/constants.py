"""
    Holds the necessary data for the generation of randomized user agents (see generators.py).
    The information on this script has been gathered from the following sources: 
...
DEVICE_TYPE         = Literal['desktop', 'mobile']                             # Device type
BROWSER_TYPE        = Literal['chrome', 'edge', 'firefox', 'safari']           # Generic Browsers
OS_TYPE             = Literal['windows', 'linux', 'android', 'macos', 'ios']   # Generic OS
NAME_TYPE           = Literal[Union[BROWSER_TYPE, OS_TYPE]]                    # Software name type
TKEY_TYPE           = Union[NAME_TYPE, BRAND_TYPE]                             # User agent template key types
...
TEMPLATES: Dict[Tuple[TKEY_TYPE, TKEY_TYPE], Tuple] = {
    ('windows', 'chrome') : (
