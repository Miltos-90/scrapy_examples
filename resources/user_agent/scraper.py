...
class Scraper(BaseGenerator):
    ...
    def __init__(self,
        ...
        browsers = [b.lower() for b in browsers] # Lowercase inputs
        self._isAvailable(browsers)
        self._getUserAgents(browsers, limit)
    ...
    def _getUserAgents(self, browsers: List[BROWSER_TYPE], limit: int):
        ...
        for browser in browsers:
            ...
            agents = self._scrapeAgents(browser, limit)
    ...
    def _scrapeAgents(self, browser : str, limit: int) -> list:
