...
# TODO: Add market adoption from statcounter: https://en.wikipedia.org/wiki/Opera_(web_browser)
# TODO: Chrome is same as opera on the user agents. Why?
...
class GenericHeaderGenerator(metaclass = Singleton):
    ...
    def __call__(self) -> dict:
        ...
        # Get a random domain and user agent (TODO: typehints for all 7 lowercase in the beginning!)
