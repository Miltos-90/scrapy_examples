...
# TODO: Fix typehints
# TODO: Generator -> do you need the browser set?
...
class GenericHeaderGenerator(metaclass = Singleton):
    ...
    def removeUnsupported(self, allHeaders, device, browser, version):
        ...
        # Get compatible headers for this browser-device combination
