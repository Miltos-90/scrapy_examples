...
# For the new stuff check if a simple random choice can be implemented
...
class DetectMobileBrowser(object):
    ...
    Found in: http://detectmobilebrowsers.com/
    """
...
if __name__ == "__main__":
    ...
    for _ in range(1):
        ...
        No. Available   Field                           Description
        --  ---------   ---------------------------     -------------------------------------------------------
        1   No          Sec-CH-UA                       User-agent's branding and significant version information.
        2   Yes         Sec-CH-UA-Arch                  CPU architecture.
        3   No          Sec-CH-UA-Bitness               size in bits of an integer or memory address—typically 64 or 32 bits.
        4   No          Sec-CH-UA-Full-Version-List     comma separated list of brands in the user agent brand list, and associated full version number
        5   Yes         Sec-CH-UA-Mobile                Indicate if this is a mobile device.
        6   Yes         Sec-CH-UA-Model                 Device model.
        7   Yes         Sec-CH-UA-Platform              Operating system name.
        8   Yes         Sec-CH-UA-Platform-Version      Operating system version.
        9               Sec-Fetch-Site
        10                Sec-Fetch-Mode
        11               Sec-Fetch-User
        12                Sec-Fetch-Dest
        13               Sec-CH-Prefers-Reduced-Motion 
        ----------------------------------------------------------------------------------------------------------
