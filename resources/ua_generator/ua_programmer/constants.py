...
OS_TYPE             = Literal['ubuntu', 'windows', 'linux', 'android', 'macos', 'ios']   # Generic OS
...
TEMPLATES: Dict[Tuple[OS_TYPE, BROWSER_TYPE], Tuple] = {
    ...
    ('windows', 'firefox') : (
        ...
        'Mozilla/5.0 (Windows NT {windows}) AppleWebKit/{webkit} (KHTML, like Gecko) Chrome/{chrome} Safari/{webkit} OPR/{opera}',
        'Opera/{opera_old} (Windows NT {windows}) Presto/{presto} Version/{opera}'
    ),
    ...
    ('linux', 'opera') : (
        'Opera/{opera_old} (X11; Linux i686; Ubuntu/{ubuntu}) Presto/{presto} Version/{opera}',
    ),
    ...
    ('macos', 'opera') : (
        ...
        'Opera/{opera_old} (Macintosh; Intel Mac OS X {macos}) Presto/{presto} Version/{opera}'
    ),
