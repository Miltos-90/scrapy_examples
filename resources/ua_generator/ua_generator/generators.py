...
class UserAgentGenerator(metaclass = Singleton):
    ...
    def __init__(self,
        osTypeDict  : dict = data.osTypes,           # Dictionary with <os>:<type>
    ...
    def __call__(self, 
        device  : str = None, # Device type  : mobile, desktop
        os      : str = None, # OS name      : windows, macos, ios, linux, android
        browser : str = None  # Browser name : chrome, edge, firefox, safari
        ) -> str:
