...
from typing      import Tuple, Union, Callable, List, Type, cast, get_args
...
class Parser(metaclass = Singleton):
    ...
    def __init__(self):
        ...
        self.parsers = { # Dictionary of base parsers
            'browser' : parserFactory('browser'),
            'cpu'     : parserFactory('cpu'),
            'device'  : parserFactory('device'),
            'engine'  : parserFactory('engine'),
            'os'      : parserFactory('os')
        }
